        ...
        {mode === 'login' && (
          <div className="grid items-center">
            <section className="mx-auto w-full max-w-[370px]">
              ...
              <form method="post" className="grid gap-y-10 py-10" onSubmit={handleLogin}>
                <input
                  type="email"
                  name="email"
                ...
                <input
                  ...
                  onChange={() => setIsFailed(false)}
                />
                <div className="grid gap-y-4 bg-white">
                  <span className={`text-red-500 ${isFailed ? 'z-auto' : '-z-50'}`}>
                ...
                <div className="flex flex-col items-start gap-y-4">
                  ...
                  <button
                    ...
                    className="!hidden text-clr-Secondary2"
                  >
                    Forgot Password
                  </button>
                </div>
            ...
            <section className="mx-auto w-full max-w-[370px]">
              ...
              >
                ...
                <div className="grid gap-y-4">
                  ...
                  <Link
                    to="https://google.com"
                    className="!hidden items-center justify-center gap-x-4 rounded border border-[#999999] py-4"
                  >
                    <Google />
                    Login with Google Account
                  </Link>
